"""
Configuration module for mockup server. Please edit here, not in mockup server.py anymore.
...
#--------------------------------------------------------------------------------------------------
#
# Edit this to select the product to test for mockup server:
#
#CONFIGURED_PRODUCT = "RRC2020B_RECALIBRATION"  # laboratory only
#CONFIGURED_PRODUCT = "RRC2020-DR_RECALIBRATION"  # laboratory only
...
#
# NOTE: if you extend, use model names from information.py module
#       and keep list in alphabetical order if possible.
#
#
#
#--------------------------------------------------------------------------------------------------
...
#
#
SELECTED_PRINTER_LOCATION = "DE_LINE_1"  # "VN_GENERIC", "DE_LINE_1", ..., "DEBUG" etc.
#
