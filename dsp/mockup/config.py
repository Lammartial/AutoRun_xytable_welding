...
#   uvicorn mockup_server:app --reload --host 0.0.0.0 --port 8022
#   uvicorn mockup_server:app --reload --host 0.0.0.0 --port 8033
#
# Then you need to set this port in the station_config.yaml of a workstation of a line.
#
#--------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------
