                ...
                case SPSStates.SYNC_ON_TOGGLE_BIT:
                    ...
                    if getattr(self.dev, 'just_restored', False):
                        ...
                        if self.next_program_no != -1:
                            print(f"🛠️ Power cut recovery: Forcing AMADA welder back to Program {self.next_program_no}...")
            ...
            while True:
                if SM is None:
                    ...
                    if self.production_mode: # and (not self.welding_for_process_validation):
                        ...
                        program_sequence = [1, 3, 13, 15, 17, 2, 10, 14, 16, 27, 28, 31, 41, 42, 26, 29, 32, 40]
                        SM = SPSStateMachine(
                            resource_str,
                            program_sequence,
