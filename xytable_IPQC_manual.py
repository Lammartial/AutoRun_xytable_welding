...
def table_state_machine(xy_table, welder, adam, udi_sock, current_state: int, table_of_positions: list, table_index: int, welding_position: int) -> Tuple[int, int, int]:
    ...
    match current_state:
        ...
        case 0:  # initialize/reset variables to start new process
                    ...
                    #     _next_state = 31
                        ...
                        if not is_move_successfully:
                            ...
                            if not is_position_close_to(current_pos, (x, y), 0.02):
                                ...
                                # Check if table is finished
                                _next_state = 0 if table_index >= len(table_of_positions) else 3
        ...
        case 4:
            ...
            if is_light_curtain_activated(adam) or is_emergency_button_pressed(adam):
                ...
                welding_position -= 1     # Minus 1 because script will move to case 3: welding_pos + 1 after escaping emergency case
        ...
        case 7:
            ...
            if is_move_button_pressed(adam):  # Press button to move to unload position
                ...
                xy_table._recovery_context = {
                    ...
                    "return_state": 0,      # after recovery, go back to state 1 (wait for operator)
                    "advance_table": False,
                }
                xy_table._power_was_cut = False
...
def test_combined_controllers(resource_str_aws: str, resource_str_xy: str, resource_str_adam: str, logger: EventLogger):
    ...
    POSITIONS_OF_PART = [  # RRC3570-4 42 positions
        ...
        ("USER", None),    # Go to unloading position to take the battery pack out
        (166.4, 183.525),
        ("WELD", 2),
        ("USER", None),
        (146.09, 242.155),
