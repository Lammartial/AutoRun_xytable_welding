Note: this is the "manufacturing" Python module which is installable by PIP but not by CONDA.
      Thus decided to copy the sources to here and rename it "cpk" under our manufacturing lib.
      MR_2023-06-28
