...
if __name__ == "__main__":
    ...
    M3412_IP_STR = "TCPIP0::169.254.208.73::inst0::INSTR" #"TCPIP0::169.254.196.86::inst0::INSTR"
    ...
    # Set OUTPUT ON/OFF
    it_m3412.set_output_state(0)                    # No return value
    ...
    # Set current. curr - string 'MIN', 'MAX' or'X.XXX' Amp
    #it_m3412.set_current('1.000')                      # No return value

    # Get current.
    #print(it_m3412.get_current())

    # Set current limit positive. curr - string 'MIN', 'MAX' or'X.XX' Amp
    #it_m3412.set_current_limit_positive('02.00')       # No return value
    ...
    #it_m3412.set_current_limit_negative('-02.00')       # No return value
