...
def table_state_machine(X_stage, Y_stage, xy_table, welder, adam, current_state: int, table_of_positions: list, table_index: int, welding_position: int) -> Tuple[int, int, int]:
    ...
    match current_state:
        ...
        case 1:
            ...
            if current_pos != (165.738, 62.525) and welding_position == 0:
...
def test_combined_controllers(resource_str_aws: str, resource_str_xy: str, resource_str_adam: str):
    ...
    while True:
        ...
        state_of_machine , table_index, welding_position = table_state_machine(X_stage, Y_stage, xy_table, welder, adam, state_of_machine, POSITIONS_OF_PART, table_index, welding_position)
